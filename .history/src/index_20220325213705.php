...
VALUES
    ('',3,3,? )
");
$sample->bindParam(1, $day, PDO::PARAM_STR);
$sample->bindParam(2, $time, PDO::PARAM_INT);
$sample->execute();
?>
        ...
        <div class="modal_content">
            <section class="modal_left">
                <div class="submit__form__item">
                    ...
                    <dd><input id="day"  name="day" class="small_textarea" onclick="calendar_open()" required="required"></input></dd>
                </div>
            <div class="submit__form__item">
            ...
            <section class="modal_right">
                <div class="submit__form__item">
                    ...
                    <dd><input id="time" type="number" name="time" class="small_textarea" required="required"></input></dd>
                </div>
                <div class="submit__form__item">
