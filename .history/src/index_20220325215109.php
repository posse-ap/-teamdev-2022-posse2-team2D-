...
VALUES
    (?,?,?,? )
");
$sample->bindValue(1, $day, PDO::PARAM_INT);
$sample->bindValue(1, $lang, PDO::PARAM_INT);
$sample->bindValue(2, $content, PDO::PARAM_INT);
$sample->bindValue(3, $time, PDO::PARAM_INT);
$sample->execute();
?>
