...
function form_submit(){
	...
	if (twitter2.checked) {
		if (s.length > 140) {
            ...
            if(document.contactForm.day.value == "" || document.contactForm.time.value == "" || document.contactForm.content.value == "" || document.contactForm.day.value == ""){
                alert("日付を学習時間を記入してください")
            }
            else{
                 //投稿画面を開く
        ...
        if(document.contactForm.day.value == "" || document.contactForm.time.value == ""){
            alert("日付を学習時間を記入してください")
        }
        else{
            modal2.style.display = 'block';
