...
$language_stmt = $db->query(
    "SELECT 
        study_languages.study_language, SUM(study_data.study_hour) as sum_study_time, study_languages.colour
    FROM 
        study_data
    JOIN 
        study_languages ON study_data.language_id = study_languages.id 
    GROUP BY
