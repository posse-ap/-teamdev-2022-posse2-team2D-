...
<body>
    ...
    <section class="page_change">
        ...
        <p><?php echo date('Y'); ?>年 <?php echo date('n'); ?>月</p>
    ...
    <form action="/" method="post" name="contactForm" id="modal" class="modal">
        ...
        <div class="modal_content">
            <section class="modal_left">
                <div class="submit__form__item">
                    ...
                    <dd><textarea id="day"  name="day" class="small_textarea" onclick="calendar_open()" required></textarea></dd>
                </div>
            <div class="submit__form__item">
            ...
            <section class="modal_right">
                <div class="submit__form__item">
                    ...
                    <dd><textarea id="time" type="number" name="time" class="small_textarea" required></textarea></dd>
                </div>
                <div class="submit__form__item">
                    <dt><label for="Twitter_comment" class="modal_title">Twitter用コメント</label></dt>
                    <dd><textarea id="Twitter_comment" type="text" name="comment" class="big_textarea" required></textarea></dd>
                </div>
        ...
        <div class="submit__form__footer">
            <button class="submit__form__button" type="submit" name="log" onclick="form_submit()">記録・投稿</button>
        </div>
