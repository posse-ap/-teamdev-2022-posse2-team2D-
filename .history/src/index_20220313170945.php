        ...
        <section class="content_left">
            <section class="cards">
                <div class="card">
                    ...
                    <p class="card_content"><?php print_r($today_study_time) ?></p>
                    <p class="card_unit">hour</p>
                </div>
                <div class="card">
                    <h2 class="card_title">Month</h2>
                    <p class="card_content"><?php print_r($month_study_time) ?></p>
                    <p class="card_unit">hour</p>
                </div>
                <div class="card">
                    <h2 class="card_title">Total</h2>
                    <p class="card_content"><?php print_r($all_study_time) ?></p>
                    <p class="card_unit">hour</p>
                </div>
            </section>
