...
<body>
    ...
    <form action="form.php" method="post" name="contactForm" id="modal" class="modal">
        ...
        <div class="modal_content">
            ...
            <div class="submit__form__item">
                ...
                <dd class="check_flex">
                    <input type="chckbox" name="content" value="N予備校" id="check0" class="check">
        ...
        <div class="submit__form__footer">
            <button class="submit__form__button" type="submit" onclick="form_submit()">記録・投稿</button>
        </div>
