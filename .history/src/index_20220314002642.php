...
$sum1 = $db->prepare('SELECT sum(study_hour) FROM study_data WHERE DATE_FORMAT(study_date, `%Y%m`)=DATE_FORMAT(study_date, `%Y%m`)');
$sum1->execute();
$sum_month_sum = $sum->fetch();
?>
